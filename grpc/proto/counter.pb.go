...
func (x *AddResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_counter_proto_rawDesc = []byte{
	...
	,
...
var file_counter_proto_depIdxs = []int32{
	0, // 0: proto.CountService.Increase:input_type -> proto.AddRequest
	1, // 1: proto.CountService.Increase:output_type -> proto.AddResponse
...
func (c *countServiceClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/proto.CountService/Increase", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCountServiceServer) Add(context.Context, *AddRequest) (*AddResponse, error) {
...
func _CountService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CountServiceServer).Add(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CountService/Increase",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CountServiceServer).Add(ctx, req.(*AddRequest))
	}
